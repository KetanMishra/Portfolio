...
export const metadata: Metadata = {
  title: 'Ketan Mishra | Portfolio',
  description:
    'Check out modern and stylish portfolio of an experienced Web Developer Ketan Mishra! Built using TypeScript, Next.js 14, Framer Motion and Tailwind CSS.',
};
